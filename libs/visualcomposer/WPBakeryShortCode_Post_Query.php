...
if ( class_exists( 'WPBakeryShortCode' ) ) {
    ...
    class WPBakeryShortCode_Post_Query extends WPBakeryShortCode {
	...
	public function resetTaxonomies() {
		//echo 'reset';
	...
	public function getFilterTaxTerms($tax) {
		return get_terms( $tax, array(
			'orderby' => 'name',
			'include' => implode( ',', $this->filter_categories )
		) );
	}
